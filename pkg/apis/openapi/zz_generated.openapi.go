...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/operator-framework/mock-extension-apiserver/pkg/apis/anything/v1alpha1.Anything": schema_pkg_apis_anything_v1alpha1_Anything(ref),
...
func schema_pkg_apis_anything_v1alpha1_Anything(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Anything is used as the underlying type for any mocked resource.",
