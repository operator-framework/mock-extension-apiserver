...
import (
	...
	"github.com/operator-framework/mock-extension-apiserver/pkg/apiserver"
)
...
func init() {
	...
	flags.StringVar(&options.OpenAPIBasePath, "open-api-base-path", "github.com/operator-framework/mock-extension-apiserver/pkg/apis", "Base path of the directory where the mocked group version kind types should live")
